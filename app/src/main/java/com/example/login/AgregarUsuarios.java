            ...
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !correo.isEmpty() && !telefono.isEmpty() && !clave.isEmpty()){
                    ...
                    if (clave.length() >=6 ){
                        ...
                        Toast.makeText(AgregarUsuarios.this, "La Clave debe ser min 6 caracteres", Toast.LENGTH_SHORT).show();
                    }

                }else{
                    Toast.makeText(AgregarUsuarios.this, "Debe Completar Los Campos", Toast.LENGTH_SHORT).show();
                }
                ...
                mDatabase.child("Clientes").child(id).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task2) {
                        ...
                        if (task2.isSuccessful()){
                            Toast.makeText(AgregarUsuarios.this, "se a registrado con exito", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(AgregarUsuarios.this,Menu.class));

                        }else{
                            Toast.makeText(AgregarUsuarios.this, "error al registrar", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    Toast.makeText(AgregarUsuarios.this, " no se pudo registrar el usuario", Toast.LENGTH_SHORT).show();
                }
